        ...
        <div class="card-body">
            <form action="{{ route('employee.update', $item->id) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="nip" class="form-control" placeholder="NIP" value="{{ $item->nip }}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="unit" class="form-control" placeholder="Unit" value="{{ $item->unit }}">
                </div>
