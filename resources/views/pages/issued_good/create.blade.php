...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Barang Bermasalah</h1>
    </div>
    ...
    <div class="card shadow">
        <div class="card-body">
            <form action="{{ route('issued_good.store') }}" method="POST">
                @csrf
                ...
                <div class="form-group">
                    <label for="date_issued">Tanggal Bermasalah</label>
                    <input type="date" name="date_issued" class="form-control" placeholder="Tanggal Bermasalah"
